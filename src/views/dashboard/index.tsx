          ...
          <tbody className="text-sm">
            {bins.map((bin) => (
              <tr key={bin.id} className="border-t border-gray-50 hover:bg-gray-50">
                ...
                <td className="p-4">
                    <span className={`px-2 py-1 rounded-full text-[10px] font-bold ${bin.capacity >= 90 ? 'bg-red-100 text-red-600' : bin.capacity >= 70 ? 'bg-orange-100 text-orange-600' : 'bg-green-100 text-green-600'}`}>
